            ...
            <div class="col-md-9 col-sm-12 col-xs-12">
                    <div class="panel-body" id="form-product">
                        <form action="shop-management.html?addProduct"  enctype="multipart/form-data" method="post">
                            ...
                            <div class="input-error" id="error-name">Bạn phải nhập tên cho sản phẩm !</div><br>
                            <label>Giá sản phẩm</label>
                            <input name="price" class="form-control" id="product-price"/>
                            <div class="input-error" id="error-price">Bạn phải nhập giá sản phẩm chính xác ( là số và lớn hơn 0 )!</div>
                            <br>
                            ...
                            <div id="select-image">
                                <button class="btn btn-primary" type="button" id="label"><i class="fa fa-image"></i> Chọn ảnh</button>
                                <input id="product-images" style="opacity: 0"  type="file" name="images"  accept=".jpg,.png,.jpeg" multiple><br>
                            </div>
                            ...
                            <div id="pro-images" class="row" ></div><br>
                            ...
                            <table class="table">
                                <tr id="add-detail">
                                    ...
                                    <td><button type="button" onclick="addDetail()" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Thêm</button></td>
                                </tr>
                            </table>
                            <button class="btn btn-success" style="margin-left: 35%"><i class="fa fa-plus"></i> Thêm sản phẩm</button>
                        </form>
                    </div>
                </div>
            </div>
...
<c:if test="${addSucceed != null}">
    ...
    <span class="hidden" id="message"><s:message code="shop-management.product.addSucceed" arguments="${addSucceed}"/></span>
    <script>
